            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ route ('barangmasuk.index')}}">barangmasuk</a>
                        <a class="collapse-item" href="{{ route ('barangkeluar.index')}}">barangkeluar</a>
